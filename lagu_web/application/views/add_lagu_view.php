...
<?php echo form_open_multipart('Kelola_lagu/insertLagu');?>
		...
		<tr>
			<td>
				<div align="center">
					...
					<div style="width:550px; height:350px;" id="container">
					
						 	  <div id="boxshadow" style="margin-top:7px;">
						 <table border = "0" align="center">
									<tr>
										<td align="center">Max file size is 8 mb, use mp3 format for song file</td>
									</tr>
									<tr>
										<td align="center" colspan="3">UPLOAD SONG<hr></td>
									</tr>
									
									<tr>
										<td align="left">UPLOAD SONG</td>
										<td>:</td>
									...
									<tr>
										...
										<?php 
											$data = array(
												...
												echo form_dropdown('genre',$data,1); ?>
										</td>
									</tr>
									<tr>
