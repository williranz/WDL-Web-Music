...
<?php
		...
		echo form_open('Album/do_download',$attributes);
?>
	<table width="100%">
		<tr>
			<td>
				<div align="center">
					...
					<div style="width:800px; height:60px;" id="container">
						<h1>DOWNLOAD</h1>
						
						<b>&nbsp;</b>
					</div >
					
					<div style="width:800px; height:370px;" id="container">
					<br>
					<img class="" src="http://localhost/lagu_web/images/star.jpg" width="300px" height="260px" alt="" title="" style="float:left; margin-right:5px; margin-left:50px; margin-bottom:5px; border:solid 4px"/> 
						 <div id="boxshadow" >
						 <table align="center" border="0">
									<tr>
										<td align="center" colspan="3">DOWNLOAD SONG<hr></td>
									</tr>
									<tr>
									...
									<tr>
										<td align="left">DOWNLOAD STREAM</td>
										<td>:</td>
										<td>
										<?php 
											$data = array(
									...
									<td colspan="3" align="center">
										<a href="<?php echo site_url('album');?>"> cancel </a> &nbsp;&nbsp;
									</td>
								</table>
